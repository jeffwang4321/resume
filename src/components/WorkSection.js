...
const WorkSection = () => {
  ...
  return (
    <section className={styles.Section}>
      ...
      <ul>
        <li>• &nbsp; Developed and optimized ASP.NET web applications for Canadian government clients in C#</li>
        <li>• &nbsp; Refactored and debugged MVC architecture, business billing logic, and SQL Server database connections</li>
        <li>• &nbsp; Responsible for database scripting, network troubleshooting, jQuery, AJAX and Vue.js debugging</li>
      </ul>
      {/* <ul id={styles.skills}>
        <li>Vue.js</li>
        <li>.NET Framework</li>
      ...
      <ul>
        ...
        <li>• &nbsp; Reduced the demand history graph's render time by 80% by implementing Redux caching</li>
        <li>• &nbsp; Developed the inactivity timeout function that automatically logs off the user after a set period of time</li>
        <li>• &nbsp; Designed and automated frontend testing using Cypress and firmware tests using Python's Fabric library</li>
      ...
      <ul>
        <li>• &nbsp; Responsible for client software setup, updates, SQL Server maintenance and database migrations</li>
        <li>• &nbsp; Setup, debugged and applied schema updates to SQL servers using SQL Server Management Studio</li>
        <li>• &nbsp; Performed cloud database setup, backups, and automated database integrity testing using C++</li>
      </ul>
      {/* <ul id={styles.skills}>
